// Copy of:
// https://github.com/Azure/bicep-registry-modules/blob/4dcf5144c249d42d6f76dc1b2ca9554735a63a02/avm/res/maps/account/main.bicep
// Edited to also output `mapsAccount.properties.uniqueId`
...
@description('The unique ID (client ID) of the Maps Account.')
output uniqueId string = mapsAccount.properties.uniqueId
